...
def run_simulation_head_to_head(raw_data_dir, output_csv_path, max_files=None):
...
if __name__ == '__main__':
    run_simulation_head_to_head('raw_data', 'scoring_results_head_to_head_temp.csv', max_files=1)